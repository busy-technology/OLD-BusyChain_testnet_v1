...
peer lifecycle chaincode commit -o localhost:7050 --channelID busychannel --name busytoken --version 1 --sequence $2 --tls true --cafile $ORDERER_CA --peerAddresses localhost:7051 --tlsRootCertFiles organizations/peerOrganizations/busy.technology/peers/peer0.busy.technology/tls/ca.crt
